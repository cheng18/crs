...
context_character_ids = tf.keras.Input(shape=(None, 50), dtype='int32')
question_character_ids = tf.keras.Input(shape=(None, 50), dtype='int32')
...
print('context shape:', elmo_context_input_.shape)
print('question shape:', elmo_question_input_.shape)
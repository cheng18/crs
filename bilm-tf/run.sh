...
export MAX_TOKEN_LENGTH=70
export BASE_DIR=/crs_elmo/bilm-tf/model/stroke_AA_s_10731134_e1_noshuffle_mtl$MAX_TOKEN_LENGTH
...
python3 option_n_char_plus_one.py \
